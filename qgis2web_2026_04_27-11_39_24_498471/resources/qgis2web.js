...
map.getView().fit([3634838.908475, -1304416.367081, 4035822.740389, -1053739.484897], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Lake Nyasa Shoreline Change (1995 - 2025)</h2>';
        return titleElement;
    })(),
